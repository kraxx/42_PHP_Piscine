...
<body>
    ...
    <form class="main-container catalog" action="additem.php" method="POST">
        <div class="title">Our best selection of multicutural dirt:</div>
        <div class="item-container">

        <?php
        $data = unserialize(file_get_contents('./secure/data'));
        if ($data['soil1o'] == 4 && $data['soil1a'] == 1)
        {
           echo '<div class="item">
        ...
        if ($data['soil2o'] == 4 && $data['soil2a'] == 1)
        {
            echo '<div class="item">
        ...
        if ($data['soil3o'] == 4 && $data['soil3a'] == 1)
        {
            echo '<div class="item">
        ...
        if ($data['soil4o'] == 4 && $data['soil4a'] == 1)
        {
            echo '<div class="item">
        ...
        if ($data['soil5o'] == 4 && $data['soil5a'] == 1)
        {
            echo '<div class="item">
        ...
        if ($data['soil6o'] == 4 && $data['soil6a'] == 1)
        {
           echo '<div class="item">
        ...
        if ($data['soil7o'] == 4 && $data['soil7a'] == 1)
        {
            echo '<div class="item">
        ...
        if ($data['soil8o'] == 4 && $data['soil8a'] == 1)
        {
            echo '<div class="item">
        ...
        if ($data['soil9o'] == 4 && $data['soil9a'] == 1)
        {
            echo '<div class="item">
