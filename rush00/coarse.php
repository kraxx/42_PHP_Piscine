...
<body>
    ...
    <form class="main-container catalog" action="additem.php" method="POST">
        <div class="title">Our most coarse selection of dirt:</div>
        <div class="item-container">

        <?php
        $data = unserialize(file_get_contents('./secure/data'));
        if ($data['soil1t'] == 3 && $data['soil1a'] == 1)
        {
           echo '<div class="item">
        ...
        if ($data['soil2t'] == 3 && $data['soil2a'] == 1)
        {
            echo '<div class="item">
        ...
        if ($data['soil3t'] == 3 && $data['soil3a'] == 1)
        {
            echo '<div class="item">
        ...
        if ($data['soil4t'] == 3 && $data['soil4a'] == 1)
        {
            echo '<div class="item">
        ...
        if ($data['soil5t'] == 3 && $data['soil5a'] == 1)
        {
            echo '<div class="item">
        ...
        if ($data['soil6t'] == 3 && $data['soil6a'] == 1)
        {
           echo '<div class="item">
        ...
        if ($data['soil7t'] == 3 && $data['soil7a'] == 1)
        {
            echo '<div class="item">
        ...
        if ($data['soil8t'] == 3 && $data['soil8a'] == 1)
        {
            echo '<div class="item">
        ...
        if ($data['soil9t'] == 3 && $data['soil9a'] == 1)
        {
            echo '<div class="item">
